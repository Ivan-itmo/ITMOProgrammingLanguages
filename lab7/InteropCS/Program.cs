...
namespace InteropLab
  ...
  class NativeWrapper
    {
    const string LibName = "InteropFastLib";
  ...
  class Program
    ...
    public static void RunDemo()
      ...
      Runtime.PythonDLL = "python312.dll"; // Укажите вашу версию Python
      ...
      using (Py.GIL())
        ...
        try
          ...
          using (var scope = Py.CreateScope())
            ...
            Console.WriteLine($"[C#] Running code from {fn}");
            scope.Exec(code);
            ...
            dynamic listClass = scope.Get(cn);
            dynamic list = listClass(pyList);
            Console.WriteLine($"[C#] Mean value {list.RMS()}");
            Console.WriteLine($"[C#] Finished running code");
            }
          }
